            ...
            <div className="search-box">
              {
                ...
                :
                  <span onClick={this.toggleSearch}><span className="glyphicon glyphicon-search"></span> { searchText }</span>
              }
            </div>
          </div>
        </div>
                  ...
                  <div className="pmd-card pmd-card-default pmd-z-depth" key={ `question-${question.id}` }>
                    <div className="pmd-card-title">
                      ...
                      <div className="media-body media-middle">
                        ...
                        <h3 className="pmd-card-title-text">{question.title}</h3>
                      </div>
                    </div>
                    <div className="pmd-card-actions">
                      ...
                      <button className="btn pmd-btn-flat pmd-ripple-effect btn-primary" type="button">32 answers</button>
                      <button type="button" className="btn pmd-btn-flat pmd-ripple-effect btn-default">active 2 minutes ago</button>
                    </div>
                  </div>
                )
              }
